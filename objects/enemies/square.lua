...
function Square:update(dt)
    ...
    if self.trail_timer >= self.trail_interval then
        ...
        self.trail_timer = self.trail_timer - self.trail_interval
...
function Square:draw()
    self:vfx()
    love.graphics.draw(self.sprite, self.x, self.y, 0, self.scale, self.scale, self.sprite:getWidth() / 2,
